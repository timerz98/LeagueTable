...
# and Chris is before Arnold in the list of players, he is ranked first. Therefore, the code above should display "Chris".
...
class LeagueTable:
    ...
    def player_rank(self, rank):
        ...
        ranking = sorted( self.standings.keys(), key= lambda player: (-self.standings[player]['score'], self.standings[player]['games_played']))
